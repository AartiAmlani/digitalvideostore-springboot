...
public class AuthController {
    ...
    public ResponseEntity login(@RequestBody UserModel user)
    {
        ...
        try{
            ...
            CustomizedResponse response = new CustomizedResponse( "You login Successfully", null);
        ...
        catch (BadCredentialsException ex)
        {
            ...
            CustomizedResponse response = new CustomizedResponse( "You username/password were entered incorrectly..", null);
